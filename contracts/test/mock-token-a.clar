...
(define-constant TOKEN_NAME "Mock Token A")
(define-constant TOKEN_SYMBOL "MOCKA")
(define-constant TOKEN_DECIMALS u6)
(define-constant TOKEN_URI u"https://example.com/mock-token-a")
...
(define-data-var token-uri (string-utf8 256) u"https://example.com/mock-token-a")
